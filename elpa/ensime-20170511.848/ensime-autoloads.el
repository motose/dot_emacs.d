...
;;;***

;;;### (autoloads nil "ensime-goto-testfile" "ensime-goto-testfile.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from ensime-goto-testfile.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ensime-goto-testfile" '("ensime-")))
...
;;;***

;;;### (autoloads nil "ensime-inspector" "ensime-inspector.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from ensime-inspector.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ensime-inspector" '("ensime-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ensime-sbt" '("ensime-sbt")))
